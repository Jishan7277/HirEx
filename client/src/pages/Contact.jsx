...
import RahatPic from "./Jishan.jpeg"
import HrushiPic from "./Yunus.jpeg"
import FaizanPic from "./Asd.jpeg"
function contact() {
  const rahat = () => {
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className=" flex-grow flex-shrink-0 flex flex-wrap justify-center py-10">
        <div class="cardAbout">
          ...
          <span>Jishan Sayyad</span>
          <p class="info">
            I'm Jack of all trades, master of none.
          </p>
          <div class="share">
            <a href="https://github.com/youreachedrahat" target="_blank">
              <svg
            ...
            <a href="https://twitter.com/youreachedrahat" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
            ...
            <a href="https://www.instagram.com/i.rahxt" target="_blank">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
            ...
            <a href="https://www.linkedin.com/in/youreachedrahat/" target="_blank">
            <svg 
                xmlns="http://www.w3.org/2000/svg" 
                width="16" 
                height="16" 
